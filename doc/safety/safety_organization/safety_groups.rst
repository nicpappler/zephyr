...
Safety Groups in the Zephyr Project
###################################

Introduction
************

The objective of this section is to define the organizational structure, specific roles,
and individual responsibilities required to achieve functional safety certification
for the Zephyr Project.
